...
/**
 * Class RedisLoggedClient
 *
 * Every call to different redis method will be timed and logged.
 * Avoid usage in production.
 *
 * @package WebonautePhpredisBundle\Client
 */
class RedisLoggedCluster extends RedisCluster
{
    ...
    /**
     * RedisLoggedCluster constructor.
     *
     * @param $name
     * @param array $seeds
    ...
    public function __construct(
        ...
        array $parameters = [],
        RedisLogger $logger = null
    )
    {
        parent::__construct($name, $seeds, $timeout, $readTimeout, $persistent);
        $this->logger = $logger;
     ...
     * @return string
     */
    private function getCommandString($command, array $arguments): string
    {
        $list = [];
